...
def shape_element(element):
    ...
    if element.tag == "node" or element.tag == "way" :
        ...
        # 2 If child tag exist then process it.
        address = dict()
        for elem in element.iter("tag"):
            ...
            # tag "k" value starts with "addr:"
            elif elem.attrib["k"].startswith("addr:"):
                # there is a second ":" that separates the type/direction of a street
                if elem.attrib["k"].find("street:") !=-1:
                    pass

                # process it 
                else: 
                    address[elem.attrib["k"].split(":")[1]] = elem.attrib["v"]

            # tag "k" value does not start with "addr:", but contains ":"
            elif elem.attrib["k"].find(":") != -1:
        ...
        # 3. if element is "way", then process ref attribute
        if element.tag == "way":
            refs = list()
